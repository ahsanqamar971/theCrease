...
public class PlayersActivity extends AppCompatActivity {
    ...
    private List<Users> playerModels = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(playerRecyclerView.getContext(),
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot:dataSnapshot.getChildren()) {
                    if (snapshot.child(IConstants.ROLE).getValue().toString().equals("Player")) {
                        playerModels.add(new Users(snapshot.child("id").getValue().toString(), snapshot.child(IConstants.EMAIL).getValue().toString(),
                ...
                adapter = new PlayersAdapter(PlayersActivity.this,playerModels);
