...
public class ScorerSignUpActivity extends AppCompatActivity {

    private EditText experienceET, numberET, eduET;
    private TextView addCounter, negCounter;
    private Button backBtn, applyBtn;

    private int counter, experience;
    private String number, edu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scorer_signup);
    ...
    private void clickListeners() {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ScorerSignUpActivity.super.onBackPressed();
            }
        });
    ...
    private void getData() {
        ...
        if(validateEntries(experience,number,edu)){
            Toast.makeText(this, "All fields are required", Toast.LENGTH_SHORT).show();
        }else {
            Utils.showpDialog();
            registerScorer(name, password, email, religion, age, sex, role, experience, number, edu);
        }
    }
...
//                .putExtra("role",role)
    ...
    private void registerScorer(String name, String password, String email, String religion, String age, String sex,
                                String role, int experience, String number, String edu) {
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    uploadData(mAuth.getCurrentUser().getUid(), name, email, religion, age, sex, role, experience,
                            number, edu);
                }else Toast.makeText(ScorerSignUpActivity.this, "Some error occurred! Try again later", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void uploadData(String uid, String name, String email, String religion, String age, String sex, String role,
                            int experience, String number, String edu) {
        ...
        reference.child(uid).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Utils.hidepDialog();
                    new SweetAlertDialog(ScorerSignUpActivity.this,SweetAlertDialog.SUCCESS_TYPE)
                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sweetAlertDialog) {
                                    mAuth.signOut();
                                    startActivity(new Intent(ScorerSignUpActivity.this, DashBoardActivity.class));
                                    finishAffinity();
                                    finish();
    ...
    private boolean validateEntries(int experience, String number, String edu) {
        return TextUtils.isEmpty(String.valueOf(experience)) || TextUtils.isEmpty(number) || TextUtils.isEmpty(edu);
    }
